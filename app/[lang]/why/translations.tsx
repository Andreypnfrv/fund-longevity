  ...
  sections: {
    ...
    meaning: {
      ...
      content: {
        ...
        [Locale.FR]: 'Nous voulons dire traiter le vieillissement comme une condition médicale. L\'objectif est de rétablir et maintenir une fonction biologique juvénile — à peu près équivalente à celle de la vingtaine — aussi longtemps que vous le souhaitez. Cela préviendrait ou inverserait les maladies liées à l\'âge au lieu de les traiter une par une.',
    ...
    missing: {
      title: {
        ...
        [Locale.DE]: 'Was fehlt?',
        [Locale.FR]: 'Qu\'est-ce qui manque ?',
        [Locale.ES]: '¿Qué falta?',
      ...
      content: {
        ...
        [Locale.FR]: 'L\'échelle. Aujourd\'hui, moins de mille personnes dans le monde travaillent sérieusement à résoudre le vieillissement — chercheurs, fondateurs de biotechs et militants confondus. Ce nombre doit augmenter d\'au moins 1000×. Il n\'existe pas d\'agence gouvernementale majeure dédiée à la fin du vieillissement. Le financement est fragmenté. La réglementation est dépassée. L\'urgence publique est quasi inexistante. Cela ne changera pas tout seul.',
