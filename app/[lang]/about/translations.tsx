...
export const aboutTranslations = {
  hero: {
    ...
    subtitle: {
      ...
      [Locale.FR]: 'Fund Longevity is a global rally for life extension. It is not a formal organization, but a non-profit initiative founded by Linus Petersson and Andrei Panferov. The goal is to make fighting aging main-stream.',
